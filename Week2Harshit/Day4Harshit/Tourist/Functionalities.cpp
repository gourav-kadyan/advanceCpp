...
{
    obj.push_back(std::make_shared<TouristVehical>(12,TouristVehicleType::Bike,2,33.3f,49,PermitType::Lease,2));
    obj.push_back(std::make_shared<TouristVehical>(144,TouristVehicleType::Cab,4,88.3f,49,PermitType::Owned,6));
    obj.push_back(std::make_shared<TouristVehical>(14,TouristVehicleType::Bus,22,12.3f,49,PermitType::Lease,9));
}
