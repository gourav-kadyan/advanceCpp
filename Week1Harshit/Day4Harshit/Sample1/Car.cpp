...
Car::Car(std::string id, std::string model, EnginePtr engine, CarType ctype)
    : m_id{id}, m_model{model}, m_engine{engine}, m_ctype{ctype}
{}

Car::Car(std::string id, float price, std::string model, EnginePtr engine, CarType ctype)
